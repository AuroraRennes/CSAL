...
#endif
#elif defined CS_PA64BIT
// added: also long physical address for long virtual addresses of 64 bit architecture
typedef unsigned long long cs_physaddr_t;
/** printf format to match cs_physaddr_t */
#define CS_PHYSFMT "010llX"    /**< printf format for physical address */
#else /* !LPAE */
...
#define CS_VAFMT "012" PRIX64    /**< printf format for virtual address */
#else
typedef uint32_t cs_virtaddr_t;
#define CS_VAFMT "08" PRIX32      /**< printf format for virtual address */
#endif

// extension: for some functions, a 64bit virtual address is needed
typedef uint64_t cs_virtaddr64_t;
#define CS_VA64FMT "012" PRIX64    /**< printf format for virtual address */
...
typedef enum {
  ...
  DEV_FTM,          /**< Fabric trace macrocell on Xilinx */
