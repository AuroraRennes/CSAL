...
const struct board known_boards[] = {
    {
        ...
        /* NOTE: stale/unused. Both applications (coresight-trace and
           ultrasight) carry their own ZCU104 registration in
           include/known-boards.h resp. include/known_boards.h and never
           link demos/. This copy wires devices->etb = tpiu with
           CS_TRIGIN_TPIU_TRIGIN, contradicting the devices->etb = etr that
           both applications actually use. Do not copy from it. */
